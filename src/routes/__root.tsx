...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "eXIn Grupo — Inmobiliaria" },
      {
        name: "description",
        content:
          "eXIn Grupo: venta de inmuebles, asesoría en crédito hipotecario y leasing, y captación de propiedades.",
      },
      { property: "og:site_name", content: "eXIn Grupo" },
