...
const creditSchema = z.object({
  ...
  property_code: opcional(40),
  approx_amount: z.number().nonnegative().max(1e12).optional().nullable(),
  notes: opcional(1500),
  consent: z.literal(true),
});
...
const acquisitionSchema = z.object({
  ...
  city: opcional(80),
  zone: opcional(80),
  expected_price: z.number().nonnegative().max(1e12).optional().nullable(),
  area_m2: z.number().nonnegative().max(1e6).optional().nullable(),
